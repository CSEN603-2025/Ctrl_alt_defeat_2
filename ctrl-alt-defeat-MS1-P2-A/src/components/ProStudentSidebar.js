...
import { FaTh, FaUser, FaFileAlt, FaBriefcase, FaNewspaper, FaBell, FaCalendarAlt ,FaChartBar,FaAward,FaExclamationTriangle } from 'react-icons/fa';
...
<Link to="/pro-student/report-appeals" className={`nav-item ${location.pathname === '/pro-student/report-appeals' ? 'active' : ''}`}>
  <FaExclamationTriangle className="nav-icon" />
  <span className="nav-label">Flagged/Rejected Reports</span>
</Link>
