...
import { FaVideo, FaVideoSlash, FaMicrophone, FaMicrophoneSlash, FaShareSquare, FaPhoneSlash, FaBell, FaPlay, FaPause, FaStop, FaHome, FaBuilding, FaUserGraduate, FaBriefcase, FaFileAlt, FaChartBar, FaCalendarCheck } from 'react-icons/fa';
...
const ScadVideoCall = () => {
  ...
  useEffect(() => {
    ...
    const handleIframeError = () => {
      showNotification('Failed to load video content', 'error');
    };
  ...
  const pauseVideo = () => {
    if (videoRef.current) {
      try {
        ...
        showNotification('Failed to pause video', 'error');
      }
    }
  };
          ...
          <div className="call-interface">
            <div className="video-container">
              <iframe
                ...
                onError={() => showNotification('Failed to load video', 'error')}
              />
            </div>
